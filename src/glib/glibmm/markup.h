 ...
 *  When this flag is set, CDATA marked sections are not passed literally to the @a passthrough function of the parser. Instead, the content of the section (without the `<![CDATA[` and `]]>`) is passed to the @a text function. This flag was added in GLib 2.12.
 * 
 ...
 *  Ignore (don't report) qualified attributes and tags, along with their contents.  A qualified attribute or tag is one that contains ':' in its name (ie: is in another namespace).  @newin{2,40}
 * 
 *  @enum ParseFlags
 * 
