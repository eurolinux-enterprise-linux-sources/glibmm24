...
{
  Glib::RefPtr<ByteArray> retvalue = Glib::wrap(g_byte_array_remove_index(gobj(), index_));
  if(retvalue)
    retvalue->reference(); //The function does not do a ref for us.
  return retvalue;
}
...
{
  Glib::RefPtr<ByteArray> retvalue = Glib::wrap(g_byte_array_remove_index_fast(gobj(), index_));
  if(retvalue)
    retvalue->reference(); //The function does not do a ref for us.
  return retvalue;
}
...
{
  Glib::RefPtr<ByteArray> retvalue = Glib::wrap(g_byte_array_remove_range(gobj(), index_, length));
  if(retvalue)
    retvalue->reference(); //The function does not do a ref for us.
  return retvalue;
}
