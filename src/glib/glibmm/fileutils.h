 ...
 *  <tt>true</tt> if the file is a regular file (not a directory). Note that this test will also return <tt>true</tt> if the tested file is a symlink to a regular file.
 * 
 ...
 *  <tt>true</tt> if the file exists. It may or may not be a regular file.
 * 
 *  @enum FileTest
 * 
