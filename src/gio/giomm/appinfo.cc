...
void AppInfo::launch_default_for_uri_async(const std::string& uri, const Glib::RefPtr<AppLaunchContext>& launch_context, const SlotAsyncReady& slot, const Glib::RefPtr<Cancellable>& cancellable)
{
  // Create a copy of the slot.
  auto slot_copy = new SlotAsyncReady(slot); 

  g_app_info_launch_default_for_uri_async(uri.c_str(), Glib::unwrap(launch_context), const_cast<GCancellable*>(Glib::unwrap(cancellable)), &SignalProxy_async_callback, slot_copy);
}

void AppInfo::launch_default_for_uri_async(const std::string& uri, const Glib::RefPtr<AppLaunchContext>& launch_context, const SlotAsyncReady& slot)
{
  // Create a copy of the slot.
  auto slot_copy = new SlotAsyncReady(slot); 

  g_app_info_launch_default_for_uri_async(uri.c_str(), Glib::unwrap(launch_context), nullptr, &SignalProxy_async_callback, slot_copy);
}

void AppInfo::launch_default_for_uri_async(const std::string& uri, const Glib::RefPtr<AppLaunchContext>& launch_context, const Glib::RefPtr<Cancellable>& cancellable)
{
  g_app_info_launch_default_for_uri_async(uri.c_str(), Glib::unwrap(launch_context), const_cast<GCancellable*>(Glib::unwrap(cancellable)), nullptr, nullptr);
}

void AppInfo::launch_default_for_uri_async(const std::string& uri, const Glib::RefPtr<AppLaunchContext>& launch_context)
{
  g_app_info_launch_default_for_uri_async(uri.c_str(), Glib::unwrap(launch_context), nullptr, nullptr, nullptr);
}
