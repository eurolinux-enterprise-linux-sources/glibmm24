...
static gboolean InterfaceSkeleton_signal_authorize_method_callback(GDBusInterfaceSkeleton* self, GDBusMethodInvocation* p0,void* data)
{
  ...
  typedef sigc::slot< bool,const Glib::RefPtr<MethodInvocation>& > SlotType;

  InterfaceSkeleton* obj = dynamic_cast<InterfaceSkeleton*>(Glib::ObjectBase::_get_current_wrapper((GObject*) self));
...
{
  using namespace Gio::DBus;
  typedef sigc::slot< void,const Glib::RefPtr<MethodInvocation>& > SlotType;
...
Glib::SignalProxy1< bool,const Glib::RefPtr<MethodInvocation>& > InterfaceSkeleton::signal_authorize_method()
{
  return Glib::SignalProxy1< bool,const Glib::RefPtr<MethodInvocation>& >(this, &InterfaceSkeleton_signal_authorize_method_info);
}
