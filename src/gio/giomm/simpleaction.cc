...
:
  // Mark this class as non-derived to allow C++ vfuncs to be skipped.
  Glib::ObjectBase(0),
  Glib::Object(Glib::ConstructParams(simpleaction_class_.init(), "name",name.c_str(),"state",const_cast<GVariant*>((state).gobj()), static_cast<char*>(0)))
{}
...
static void SimpleAction_signal_activate_callback(GSimpleAction* self, GVariant* p0,void* data)
{
  ...
  SimpleAction* obj = dynamic_cast<SimpleAction*>(Glib::ObjectBase::_get_current_wrapper((GObject*) self));
