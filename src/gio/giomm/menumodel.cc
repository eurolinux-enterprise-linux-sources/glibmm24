...
static void MenuModel_signal_items_changed_callback(GMenuModel* self, gint p0,gint p1,gint p2,void* data)
{
  ...
  MenuModel* obj = dynamic_cast<MenuModel*>(Glib::ObjectBase::_get_current_wrapper((GObject*) self));
...
Glib::SignalProxy3< void,int,int,int > MenuModel::signal_items_changed()
{
  return Glib::SignalProxy3< void,int,int,int >(this, &MenuModel_signal_items_changed_info);
}
