...
gboolean Permission_Class::acquire_vfunc_callback(GPermission* self, GCancellable* cancellable, GError** error)
{
  ...
  {
    gboolean retval = (*base->acquire)(self, cancellable, error);
    if(*error)
...
gboolean Permission_Class::acquire_finish_vfunc_callback(GPermission* self, GAsyncResult* result, GError** error)
{
  ...
  {
    gboolean retval = (*base->acquire_finish)(self, result, error);
    if(*error)
      ::Glib::Error::throw_exception(*error);
    return retval;
  }
...
gboolean Permission_Class::release_vfunc_callback(GPermission* self, GCancellable* cancellable, GError** error)
{
  ...
  {
    gboolean retval = (*base->release)(self, cancellable, error);
    if(*error)
      ::Glib::Error::throw_exception(*error);
    return retval;
  }
...
gboolean Permission_Class::release_finish_vfunc_callback(GPermission* self, GAsyncResult* result, GError** error)
{
  ...
  {
    gboolean retval = (*base->release_finish)(self, result, error);
    if(*error)
      ::Glib::Error::throw_exception(*error);
    return retval;
  }
...
{
  GError* gerror = 0;
  bool retvalue = g_permission_acquire(gobj(), 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
void Permission::acquire_async(const SlotAsyncReady& slot)
{
  ...
  g_permission_acquire_async(gobj(), 0, &SignalProxy_async_callback, slot_copy);
}
...
{
  GError* gerror = 0;
  bool retvalue = g_permission_release(gobj(), 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
void Permission::release_async(const SlotAsyncReady& slot)
{
  ...
  g_permission_release_async(gobj(), 0, &SignalProxy_async_callback, slot_copy);
}
