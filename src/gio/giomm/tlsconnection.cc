...
{
  using namespace Gio;
  typedef sigc::slot< bool,const Glib::RefPtr<const TlsCertificate>&,TlsCertificateFlags > SlotType;

  TlsConnection* obj = dynamic_cast<TlsConnection*>(Glib::ObjectBase::_get_current_wrapper((GObject*) self));
...
{
  using namespace Gio;
  typedef sigc::slot< void,const Glib::RefPtr<const TlsCertificate>&,TlsCertificateFlags > SlotType;
...
gboolean TlsConnection_Class::handshake_vfunc_callback(GTlsConnection* self, GCancellable* cancellable, GError** error)
{
  ...
  {
    gboolean retval = (*base->handshake)(self, cancellable, error);
    if(*error)
...
gboolean TlsConnection_Class::handshake_finish_vfunc_callback(GTlsConnection* self, GAsyncResult* result, GError** error)
{
  ...
  {
    gboolean retval = (*base->handshake_finish)(self, result, error);
    if(*error)
      ::Glib::Error::throw_exception(*error);
    return retval;
  }
...
{
  GError* gerror = 0;
  bool retvalue = g_tls_connection_handshake(gobj(), 0, &(gerror));
  if(gerror)
    ::Glib::Error::throw_exception(gerror);
  return retvalue;
}
...
void TlsConnection::handshake_async(const SlotAsyncReady& slot, int io_priority)
{
  ...
  g_tls_connection_handshake_async(gobj(), io_priority, 0, &SignalProxy_async_callback, slot_copy);
}
...
Glib::SignalProxy2< bool,const Glib::RefPtr<const TlsCertificate>&,TlsCertificateFlags > TlsConnection::signal_accept_certificate()
{
  return Glib::SignalProxy2< bool,const Glib::RefPtr<const TlsCertificate>&,TlsCertificateFlags >(this, &TlsConnection_signal_accept_certificate_info);
}
