...
{
  using namespace Gio;
  using SlotType = sigc::slot< bool,guint >;
...
Glib::SignalProxy< bool,guint > Settings::signal_writable_change_event()
{
  return Glib::SignalProxy< bool,guint >(this, &Settings_signal_writable_change_event_info);
}
